...
def calibrate(dirpath, image_format,square_size):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--width', type=int, required=False, help='chessboard width size, default is 7')
    parser.add_argument('--height', type=int, required=False, help='chessboard height size, default is 7')
    ...
    # values = load_coefficients('camera.yml')
    # print(values)